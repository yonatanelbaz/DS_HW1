...
public:
    ...
    StatusType mergeTeam(std::shared_ptr<Team> team1, std::shared_ptr<Team> team2);
    ...
    void arrToTeam(std::shared_ptr<Player> arr1Id, std::shared_ptr<Player> arr2Id, std::shared_ptr<Team> teamToInsert);
